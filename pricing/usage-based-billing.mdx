...
Slai charges based on the actual compute you use, and is billed by the second of usage.  Your cost is based on the combination of CPU and Memory used, and will vary based on whether you're using a CPU or GPU. 
...
**$0.10 / hour per GPU, or $0.025 / hour per GB memory - whichever is greater**
