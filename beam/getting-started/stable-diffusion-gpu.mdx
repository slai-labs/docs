...
description:
  "A short tutorial on deploying Stable Diffusion on GPU"
---
...
<Warning>You need an access token from [Huggingface](https://huggingface.co) to run this example. You can sign up for Huggingface and access your token on [the settings page](https://huggingface.co/settings/tokens).</Warning>
