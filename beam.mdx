---
title: "Introduction"
description: "Beam is a cloud platform where you can provision infrastructure, develop on remote runtimes from your local machine, and deploy apps as serverless functions — without leaving your IDE"
---

### Getting started

1. [Download the CLI](beam/getting-started/install-beam)
2. [Create an account](https://www.slai.io/login)
